...
class ProductProvider with ChangeNotifier {
  final List<Product> _items = [
    Product(
        id: '1',
        title: 'Oraimo 9',
        desc: 'An oraimo headset which is nothing like apple',
        amount: 549,
        image:
    ...
    Product(
        id: '2',
        title: 'Apple Watch',
        desc: 'An apple watch which is nothing like apple',
        amount: 632,
        image:
    ...
    Product(
        ...
        desc: 'A ploaroid camera which is nothing like apple',
        amount: 1200,
        image:
    ...
    Product(
        id: '4',
        title: 'Premium shoe',
        desc: 'A premium shoe which is nothing like apple',
        amount: 1050,
        image:
